...
const RightBar = () => {
  ...
  return (
    <div className="w-1/2 sticky hidden overflow-y-auto my-2 lg:flex flex-col items-stretch overflow-x-hidden px-6 py-4 gap-3">
        <form onSubmit={handleSubmit} className="relative w-full h-fit group">
        <input
        id="searchBox"
        className="outline-blue-400 bg-cyan-50 text-gray-800 w-full h-full rounded-xl py-2 pl-14 pr-4"
          type="text"
          placeholder="Search"
          value={input}
